...
<body onload="return use()" background="E:\Project\background_home.jpg">
	<form method="post" action="cartons_addproducts1.jsp" onsubmit="return check()">
			<center>
			<h3>Enter New Carton Details</h3>
				<table border="1" width="50%">
					<tr>
						<td>Enter Product ID : </td>
						<td><input type="text" name="cpid" value="">
					</tr>
					<tr>
						<td>Enter Product Name : </td>
						<td><input type="text" name="cpname" value=""> 
					</tr>
					<tr>
