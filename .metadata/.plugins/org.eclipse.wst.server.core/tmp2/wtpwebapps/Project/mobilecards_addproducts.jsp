...
<body onload="return use()" background="E:\Project\background_home.jpg">
	<form method="post" action="mobilecards_addproducts1.jsp" onsubmit="return check()">
			<center>
			<h3>Enter New Mobile Cards Details</h3>
				<table border="1" width="50%">
					<tr>
						<td>Enter Product ID : </td>
						<td><input type="text" name="mcpid" value="">
					</tr>
					<tr>
						<td>Enter Product Name : </td>
						<td><input type="text" name="mcpname" value=""> 
					</tr>
					<tr>
